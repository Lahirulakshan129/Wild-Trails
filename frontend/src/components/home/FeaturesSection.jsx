export default function FeaturesSection() {
  const features = [
    {
      icon: <img src="src/assets/airport.png" alt="Safari Jeep" className="w-20 h-20" />,
      title: 'Modern Transports',
      description: 'Airport Transport'
    },
    {
      icon: <img src="src/assets/surf-icon.jpg" alt="Tiger" className="w-20 h-20" />,
    ...
    {
      icon: <img src="src/assets/rickshaw.png" alt="Hotel" className="w-20 h-20" />,
      title: 'Full Day Trip',
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-8">
          {features.map((feature, index) => (
            <div key={index} className="text-center">
              ...
              <p className="bg-[#C6E3B3] mx-8 py-1 rounded-xl text-safari-charcoal/80 text-base">{feature.description}</p>
            </div>
          ))}
        </div>
