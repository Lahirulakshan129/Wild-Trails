...
const MOCK_REVIEWS = [
  {
    ...
    rating: 5,
    date: "May 24, 2025",
    comment: "Amazing experience! Our guide was knowledgeable and we saw so many elephants and birds. Will definitely recommend to friends.",
    verified: true,
  ...
  },
  {
    ...
    rating: 4,
    date: "May 23, 2025",
    comment: "Great safari, though it was very hot. The driver was excellent and made sure we saw lots of wildlife.",
    verified: true,
  ...
  },
  {
    ...
    rating: 3,
    date: "May 22, 2025",
    comment: "Decent experience but the vehicle was uncomfortable. We did see a leopard which was amazing!",
    verified: false,
  ...
  },
  {
    ...
    rating: 5,
    date: "May 21, 2025",
    comment: "Incredible safari! We saw a bear, elephants, and many birds. Our guide was extremely knowledgeable.",
    verified: true,
  ...
  },
  {
    ...
    rating: 2,
    date: "May 20, 2025",
    comment: "Disappointing. Too crowded and we barely saw any animals. The driver was nice but seemed in a rush.",
    verified: true,
              ...
              <tr key={review.id} className="border-b border-gray-100 text-sm">
                <td className="px-4 py-3">
                  <div className="flex items-center">
                    <span className="font-medium text-safari-forest">{review.customerName}</span>
                    {review.verified && (
                      <Badge
                        variant="outline"
