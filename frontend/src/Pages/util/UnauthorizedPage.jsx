    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 to-purple-800 flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden border border-white/20">
        <div className="p-8 text-center">
          ...
          <button
            onClick={() => navigate('/')}
            className="group relative overflow-hidden px-6 py-3 bg-white text-indigo-900 font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
          >
        ...
        {/* Footer */}
        <div className="bg-black/10 py-4 text-center">
      ...
      <div className="absolute top-10 left-10 w-16 h-16 rounded-full bg-purple-400/20 blur-xl"></div>
      <div className="absolute bottom-20 right-20 w-24 h-24 rounded-full bg-indigo-400/20 blur-xl"></div>
      <div className="absolute top-1/3 right-1/4 w-12 h-12 rounded-full bg-pink-400/20 blur-xl"></div>
    </div>
  );
};
